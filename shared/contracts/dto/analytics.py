"""Analytics DTOs — hourly, daily, known users."""
...
class AnalyticsHourlyDTO(TimestampedDTO):
...
class AnalyticsDailyDTO(TimestampedDTO):
...
class AnalyticsKnownUserDTO(BaseModel):
    """Known user response."""
