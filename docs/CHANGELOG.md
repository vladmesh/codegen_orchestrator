...
- Pre-agent infrastructure refusals now converge across scheduler restarts without spending an iteration; story recovery remains one exact, locked admin action.
